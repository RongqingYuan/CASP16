...
def get_group_by_target(csv_list, csv_path, feature, model, mode, impute_value=-2):
...
for feature in features:
    get_group_by_target(csv_list, csv_path, feature,
                        model, mode, impute_value=impute_value)
