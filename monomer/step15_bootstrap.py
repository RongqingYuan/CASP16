...
sns.heatmap(win_matrix, annot=False, cmap='Greys', cbar=True, square=True,)
# set the axis labels to be the group names
...
plt.show()
plt.savefig(
    "./bootstrap/win_matrix_bootstrap_{}_n={}.png".format(mode, bootstrap_rounds), dpi=300)
