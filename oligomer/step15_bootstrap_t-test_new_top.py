...
file_path = "./bootstrap_new_EU/"
out_path = "./bootstrap_analysis_new_EU/"
measure = "GDT_TS"
...
dict_file = f"{measure_type}_{model}_{mode}_p={p_value_threshold}_equal_weight={equal_weight}_ranking_t_test.txt"
dict_obj = None
