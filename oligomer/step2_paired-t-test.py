...
to_drop = ["Mol.Size", "No.Conts", "No.Clash"]
data_whole = data_whole.drop(to_drop, axis=1)
print(data_whole.head())
print(data_whole.shape)
...
wanted_group = data_whole_by_target.columns
wanted_group = [group for group in wanted_group if group !=
                'target' and group != 'submission_id']
points = {}
