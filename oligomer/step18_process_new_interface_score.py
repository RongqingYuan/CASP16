...
def group_by_target(results_dir, result_files, out_dir,
    ...
    for result_file in result_files:
        ...
        # check if all values are the same in data_tmp_0
        if nr_interf_group_in_ref.nunique() == 1:
            # print("All values are the same in data_tmp_0")
            pass
        else:
            print("Not all values are the same in data_tmp_0")
...
removed_targets = ["T1219", "T1269", "H1265", "T1295", "T1249"]
